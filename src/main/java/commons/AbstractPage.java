...
//import actions.PageManageDriver;
...
public class AbstractPage {
	...
	public void clickToDynamicElement(WebDriver driver, String fieldName) {
		waitForVisible(driver, interfaces.AbstractPageUI.DYNAMIC_INPUT_FIELD, fieldName);
		clickToElement(driver, interfaces.AbstractPageUI.DYNAMIC_INPUT_FIELD, fieldName);
	}
	...
	public void sendKeyToDynamicInputElement(WebDriver driver, String inputFieldName, String value) {
		waitForVisible(driver, interfaces.AbstractPageUI.DYNAMIC_INPUT_FIELD, inputFieldName);
		sendKeyToElement(driver, interfaces.AbstractPageUI.DYNAMIC_INPUT_FIELD, value, inputFieldName);
	}
	...
	public actions.HomePageObject openHomePage(WebDriver driver) {
		waitForVisible(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, "Manager");
		clickToElement(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, "Manager");
		return actions.PageManageDriver.getHomePage(driver);
	}
	
	public actions.HomePageObject acceptDeleteAlert(WebDriver driver) {
		acceptAlert(driver);
		return actions.PageManageDriver.getHomePage(driver);
	}
	
	public actions.NewCustomerPageObject openNewCustomerPage(WebDriver driver) {
		waitForVisible(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, "New Customer");
		clickToElement(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, "New Customer");
		return actions.PageManageDriver.getNewCustomerPage(driver);
	}

	public actions.EditCustomerPageObject openEditCustomerPage(WebDriver driver) {
		waitForVisible(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, "Edit Customer");
		clickToElement(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, "Edit Customer");
		return actions.PageManageDriver.getEditCustomerPage(driver);
	}
	
	public actions.LoginPageObject openLogOutPage(WebDriver driver) {
		waitForVisible(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, "Log out");
		clickToElement(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, "Log out");
		acceptAlert(driver);
		return actions.PageManageDriver.getLoginPage(driver);
	}
	
//	public AbstractPage openDynamicPage(WebDriver driver, String pageName) {
//		waitForVisible(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, pageName);
//		clickToElement(driver, interfaces.AbstractPageUI.DYNAMIC_LINK, pageName);
//		switch (pageName) {
//		case "New Customer":
...
//	}
	...
	public String getTextCurrentBalance(WebDriver driver) {
		waitForVisible(driver, interfaces.AbstractPageUI.CURRENT_BALANCE);
		return getTextElement(driver, interfaces.AbstractPageUI.CURRENT_BALANCE);
	}
